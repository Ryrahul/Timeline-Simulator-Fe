...
export function CardNode({ data }: { data: CardNodeData }) {
  const description =
    "summary" in data.item
      ...
      : "No description available for question node.";
  ...
  return (
    <div className="min-w-[340px] max-w-[400px]">
      <Handle
        ...
        className="w-4 h-4 border-2 border-white shadow-xl rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 hover:scale-110 transition-transform"
      />

      <Card className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-gray-700/50 shadow-2xl hover:shadow-cyan-500/20 transition-all duration-500 hover:scale-[1.03] group relative overflow-hidden backdrop-blur-sm">
        ...
        <CardContent className="p-6 relative z-10">
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="flex items-center space-x-2 mt-1">
                  <div className="text-xs text-gray-400 font-mono bg-gray-800/60 px-2 py-1 rounded border border-gray-600/50">
                    {shortId}
                  </div>
                  {isTimeline && (
            ...
            {isTimeline && (
              ...
              >
                ...
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-gradient-to-r from-pink-400 to-purple-500 rounded-full opacity-0 group-hover/fork:opacity-100 animate-ping" />
              </button>
            )}
          </div>
          ...
          <div className="flex items-center justify-between mt-5 pt-4 border-t border-gray-700/30">
            <div className="flex items-center space-x-2">
              <div className="w-8 h-1 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-full opacity-60 group-hover:opacity-100 transition-opacity" />
              <div className="w-4 h-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full opacity-40 group-hover:opacity-80 transition-opacity" />
              <div className="w-2 h-1 bg-gradient-to-r from-pink-500 to-red-500 rounded-full opacity-20 group-hover:opacity-60 transition-opacity" />
            </div>
            ...
            >
              ...
              <ArrowRight className="w-3 h-3 transform group-hover:translate-x-1 group-hover:scale-110 transition-all duration-300" />
            </div>
          </div>
          ...
          <div
            className={`absolute inset-0 rounded-lg opacity-0 group-hover:opacity-20 transition-opacity duration-500 pointer-events-none ${
              isTimeline
                ...
                : "bg-gradient-to-br from-amber-400/20 via-orange-500/20 to-red-500/20"
            }`}
          />
        </CardContent>
      </Card>
      ...
      <Handle
        ...
        className="w-4 h-4 border-2 border-white shadow-xl rounded-full bg-gradient-to-r from-purple-500 to-pink-500 hover:scale-110 transition-transform"
      />
    </div>
  );
}
